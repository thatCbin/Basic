...
public class UIUtils {
    ...
    public static void showToastLeft(String msg) {
        //showToast(msg, Toast.LENGTH_SHORT);
        ToastUtils.setGravity(Gravity.LEFT, 0, 150);
        ToastUtils.showShort(msg);
    }
    ...
    public static void showToast(String msg, int duration) {
        if (mToast == null) {
            mToast = Toast.makeText(Utils.getApp(), "", duration);
    ...
    public static String getVersionName() {
        try {
            String versionName = getContext().getPackageManager().getPackageInfo(getPackageName(), 0).versionName;
            return versionName;
        } catch (Exception e) {
            e.printStackTrace();
        }
